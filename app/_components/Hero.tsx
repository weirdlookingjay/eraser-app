    ...
    return (
        <section className="bg-black">
            <div className='flex items-baseline justify-center pt-20'>
                <h2 className='text-white border px-3 p-2 rounded-full text-center border-white'>See What's New</h2>
            </div>
            ...
            <div className="mx-auto h-screen max-w-screen-xl px-4 py-10 lg:flex">
                <div className="mx-auto max-w-xl text-center">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <a
                            className="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-black shadow hover:bg-gray-300 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
                            href="#"
                        >
                            Learn More
                        </a>
